...
const EditSlider = (props) => {
  ...
  const { loading, editSlider, error } = useSliders();
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const response = await editSlider(sliderData);
          ...
          >
            ...
            <Form className="form" ref={form} onSubmit={submitHandler}>
              <Form.Group className="mb-3" controlId="image">
                <Form.Label>صوره السلايدر</Form.Label>
              ...
              <Form.Group className="mb-3" controlId="status">
                ...
                <Form.Select
                  defaultValue={
                    props.slider?.vendorId ? props.slider?.vendorId : ""
                  }
                >
                  <option value={""}>----</option>
