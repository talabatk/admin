...
const EditVendor = (props) => {
  ...
  const { loading, updateVendor, error } = useVendors();
  ...
  const submitHandler = async (e) => {
    ...
    vendorData.append("id", props.vendor.id);
    ...
    try {
      ...
      if (response.name) {
        props.showMessage("success", "تمت الاضافه", "تم تعديل المطعم بنجاح");
            ...
            <Form className="form" ref={form} onSubmit={submitHandler}>
              ...
              <Form.Group className="mb-3" controlId="Description">
                ...
                <textarea
                  ...
                  rows={3}
                  defaultValue={props.vendor?.description}
                  required
                ></textarea>
              </Form.Group>
              ...
              <Form.Group className="mb-3" controlId="address">
                ...
                <Form.Control
                  type="text"
                  defaultValue={props.vendor?.address}
                  placeholder="العنوان"
                  required
                />
              </Form.Group>
              <Form.Group className="mb-3" controlId="phone">
                ...
                <Form.Control
                  ...
                  min={0}
                  defaultValue={props.vendor?.delivery_time}
                  required
                />
              </Form.Group>
              <Form.Group className="mb-3" controlId="free">
                ...
                <Form.Control
                  ...
                  placeholder="لا يوجد"
                  min={0}
                  defaultValue={props.vendor?.free_delivery_limit}
                />
              </Form.Group>
              <Form.Group className="mb-3" controlId="type">
                ...
                <Form.Select required defaultValue={props.vendor?.email}>
              ...
              <Form.Group className="mb-3" controlId="status">
                ...
                <Form.Select required defaultValue={props.vendor?.status}>
